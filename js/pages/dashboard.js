    ...
    container.innerHTML = `
      <div class="space-y-6">
        ...
        <div class="grid grid-cols-3 gap-3">
          ...
          <a href="#trade-calculator" class="bg-surface hover:bg-surface-light border border-gray-800 rounded-2xl p-3 transition-colors text-center">
            <svg class="w-5 h-5 text-emerald-400 mx-auto mb-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
            <div class="text-xs font-semibold">Calculator</div>
          </a>
